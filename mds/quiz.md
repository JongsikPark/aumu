...
## 🤖 AI Quiz Disclaimer
* 본 퀴즈는 AUMU의 내용을 토대로 AI(Gemini) 시스템을 통해 자동 생성된 문항들입니다.
* 기술의 변화나 모델의 한계로 인해 간혹 오답이나 논란의 여지가 있는 해설이 포함될 수 있습니다. 
* 100% 맹신하기보다는 내 지식을 가볍게 리프레시하는 **'Self-Test' 용도**로 재미있게 풀어보시는 것을 권장합니다.
